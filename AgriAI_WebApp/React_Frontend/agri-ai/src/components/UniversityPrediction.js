    ...
    if(predictionData.final_prediction) {
        ...
        <div className="form">
            <div className="form__form_group">
                ...
                <TextField onChange={(e) => handleChange(e)} value={formData.G} className="form__text_field" id="N" name="N" variant="filled" label="Amount of Nitrogen in Soil" />
                <TextField onChange={(e) => handleChange(e)} value={formData.T} className="form__text_field" id="P" name="P" variant="filled" label="Amount of Phosphorous in Soil" />
                <TextField onChange={(e) => handleChange(e)} value={formData.U} className="form__text_field" id="K" name="K" variant="filled" label="Amount of Pottasium in Soil" />
                <TextField onChange={(e) => handleChange(e)} value={formData.S} className="form__text_field" id="temperature" name="temperature" variant="filled" label="Temperature (in Celcius)" />
                <TextField onChange={(e) => handleChange(e)} value={formData.L} className="form__text_field" id="humidity" name="humidity" variant="filled" label="Humidity (in %)" />
                <TextField onChange={(e) => handleChange(e)} value={formData.C} className="form__text_field" id="ph" name="ph" variant="filled" label="pH value of Soil" />
                <TextField onChange={(e) => handleChange(e)} value={formData.R} className="form__text_field" id="rainfall" name="rainfall" variant="filled" label="Rainfall (in mm)" />

                <Button onClick={()=>handleClick()} className="form__button" color="primary" variant="contained">predict_chances_of_admission</Button>
            </div>
        </div>
    )
}

export default UniversityPrediction
